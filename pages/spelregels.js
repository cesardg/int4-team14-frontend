      ...
      <h1 className={styles.title}>De spelregels</h1>
          ...
          <WindowLayout title="het spel in het kort" bg="var(--brown)" border="var(--orange)">
            <div className={styles.shortContainer}>
              <article className={styles.article}>
                ...
                <p>Hack-Tic is een spel waarbij een hacker en een gebruikers account het tegen elkaar opnemen in de strijd om de gegevens van een account. De beide spelers beginnen bij “START” en verplaatsen hun pion tijdens hun beurt zoveel vakjes over het speelbord als ze gegooid hebben met de dobbelsteen. 
              ...
              <div className={styles.articlePurposeContainer}>
                ...
                <article className={styles.articlePurpose}>
                  ...
                  <p>Alle tekens in het wachtwoord van de gebruiker te weten komen.</p>
                </article>
              </div>
            </div>
          </WindowLayout>
          ...
          <WindowLayout title="opstart" bg="var(--brown)" border="var(--yellow)">
            <div className={styles.container}>
               <article className={styles.article}>
                ...
                <p className={styles.para}>
                 Eén speler start een nieuw spel, deze speler krijgt als eerste de keuze welke rol hij wilt aannemen tijdens het spel : hacker of gebruiker?  Daarna ontvangt hij een code die de tegenspeler correct moet invoeren in het “neem deel aan een spel”-vak.  De tegenspeler krijgt automatisch de andere rol toegewezen. 
                </p>
                <p className={styles.para}>
                 De gebruiker moet een account aanmaken met een gebruikersnaam, e-mailadres, profielfoto, sterk wachtwoord en enkele interesses. Maar ook de hacker krijgt de kans om een avatar te kiezen en een schuilnaam en e-mailadres in te voeren.
                </p>
                <p className={styles.para}>
        ...
        <div className={styles.hackerUserWrapper}>
          <div className={styles.userLayoutWrapper}>
              <WindowLayout title="de gebruiker" bg="var(--brown)" border="var(--red)">
                ...
                <div className={styles.userContainer}>
                  ...
                  <p >
                   Wanneer u op een actievak terecht komt, springt  op uw scherm een venster open waarin u de keuze krijgt uit 6 verschillende acties. Deze acties kunt u gebruiken om uw account uit de klauwen van de hacker te houden. Deze 6 acties luiden als volgt: 
                  </p>
                  </article>
                </div>
              </WindowLayout>
              ...
              <WindowLayout title="de hacker" bg="var(--black)" border="var(--green)">
                ...
                <div className={styles.hackerContainer}>
                  ...
                  <h3 className={styles.subTitle}>De hacker</h3>
                   <h4 className={styles.smallTitle}>actie-vak</h4>
                  <p >
                   Wanneer u op een actievak terecht komt, springt  op uw scherm een venster open waarin u de keuze krijgt uit 6 verschillende acties om het account van de user binnen te dringen. Deze 6 acties luiden als volgt: 
                  </p>
                  </article>
                </div>
              </WindowLayout>
