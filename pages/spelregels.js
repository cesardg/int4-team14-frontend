              ...
              >
                <div className={styles.shortContainer}>
                  <article className={styles.article}>
                    ...
                    <p>
                      Hack-Tic is een spel waarbij een hacker en een
                      user-account het tegen elkaar opnemen in de strijd om de
                  ...
                  <div className={styles.articlePurpose}>
                    ...
                    <article className={styles.article}>
                      ...
                      <p>
                        Alle tekens in het wachtwoord van de user te weten komen
                      </p>
                    </article>
                  </div>
                </div>
            ...
            >
              <div className={styles.container}>
                <article className={styles.article}>
                  ...
                  <p>
                    Hack-Tic is een spel waarbij een hacker en een user-account
                    het tegen elkaar opnemen in de strijd om de gegevens van een
                    account. De beide spelers beginnen bij “START” en
                    verplaatsen hun pion tijdens hun beurt zoveel vakjes over
                    het speelbord als ze gegooid hebben met de dobbelsteen. Naar
                    gelang het vakje waar de speler op belandt, zijn er
                    verschillende acties die hem vooruit kunnen helpen tijdens
                    het spel. Dit spel wordt zowel online als op een fysiek bord
                    gespeeld.
                  </p>
                </article>
              </div>
